...
Nytescript Intepreter, written by @_nnn_ (A.K.A @FlyBoyAce2) in Python 3.12.9 and 3.13.2	
...
Nothing is needed to be installed except the 'shell.py' file and preferrably python 3.12 and above.
...
class BuiltInFunction(BaseFunction):
	...
	def __repr__(self):
		return f"<Nytescript Function {self.name}>"
